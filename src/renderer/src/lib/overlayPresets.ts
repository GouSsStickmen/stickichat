...
.line:nth-child(4n){transform:rotate(-1deg);margin-left:4px}
.line:nth-child(4n+1){transform:rotate(.7deg);margin-left:14px}
.line:nth-child(4n+2){transform:rotate(-.4deg);margin-left:8px}
.line:nth-child(4n+3){transform:rotate(1.1deg);margin-left:18px}
.line:nth-child(3n+1) .content::after{content:'';display:block;height:6px;margin-top:-1px;opacity:.5;background:url("data:image/svg+xml,%3Csvg%20xmlns%3D%27http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%27%20width%3D%27120%27%20height%3D%276%27%3E%3Cpath%20d%3D%27M2%203%20q30%204%2060%200%20t56%201%27%20fill%3D%27none%27%20stroke%3D%27%2333508c%27%20stroke-width%3D%271.6%27%2F%3E%3C%2Fsvg%3E") repeat-x left center}`
    }
  }
]
